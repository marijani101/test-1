...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance', 'check_restriction']], function () {
    ...
    Route::group(['prefix' => 'course'], function () {
        ...
        Route::group(['middleware' => 'web.auth'], function () {
            ...
            Route::group(['prefix' => '/learning/{slug}/Transcription'], function () { // LearningPageTanscriptionTrait
                Route::get('/', 'LearningPageController@forum');
                Route::post('/store', 'LearningPageController@TranscriptionStoreNewQuestion');
    ...
    Route::group(['prefix' => 'Transcription'], function () {
