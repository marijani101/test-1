...
<!-- 
        ...
        {{-- @if($homeSection->name == \App\Models\HomeSection::$Transcription_section and !empty($TranscriptionSection))
            <section class="home-sections home-sections-swiper container find-instructor-section position-relative">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                        <div class="position-relative ">
                            <img src="{{ $TranscriptionSection['image'] }}" class="find-instructor-section-hero" alt="{{ $TranscriptionSection['title'] }}">
                            <img src="/assets/default/img/home/circle-4.png" class="find-instructor-section-circle" alt="circle">
                            <img src="/assets/default/img/home/dot.png" class="find-instructor-section-dots" alt="dots">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="">
                            <h2 class="font-36 font-weight-bold text-dark">{{ $TranscriptionSection['title'] ?? '' }}</h2>
                            <p class="font-16 font-weight-normal text-gray mt-10">{{ $TranscriptionSection['description'] ?? '' }}</p>

                            <div class="mt-35 d-flex align-items-center">
                                @if(!empty($TranscriptionSection['button1']) and !empty($TranscriptionSection['button1']['title']) and !empty($TranscriptionSection['button1']['link']))
                                    <a href="{{ $TranscriptionSection['button1']['link'] }}" class="btn btn-primary mr-15">{{ $TranscriptionSection['button1']['title'] }}</a>
                                @endif

                                @if(!empty($TranscriptionSection['button2']) and !empty($TranscriptionSection['button2']['title']) and !empty($TranscriptionSection['button2']['link']))
                                    <a href="{{ $TranscriptionSection['button2']['link'] }}" class="btn btn-outline-primary">{{ $TranscriptionSection['button2']['title'] }}</a>
                                @endif
                            </div>
                        </div>
                    </div>
